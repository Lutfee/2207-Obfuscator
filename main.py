...
def apk_decompile(apk_file):
    ...
    os.system(f"java -jar C:/Users/khair/PycharmProjects/pythonProject2/tools/apktool.jar d -f -r {apk_file} -o original_apk/{apk_name}")
    os.system(f"java -jar C:/Users/khair/PycharmProjects/pythonProject2/tools/apktool.jar d -f -r {apk_file} -o output/{apk_name}")
...
def apk_recompile_sign(apk_file):
    apk_name = os.path.basename(apk_file)
    subprocess.call(f"java -jar C:/Users/khair/PycharmProjects/pythonProject2/tools/apktool.jar b -f -r --use-aapt2 output/{apk_file} -o data_files/obfuscated_apk/{apk_name}")
    time.sleep(3)
    ...
    with open(smaliCodeFile, "r") as fp:
        ...
        for line in lines:
            ...
            if line.__contains__(".method") and ("constructor" not in line) and ("onCreate" not in line):
                numOfCharacters = random.randint(0, 10)
